...
public class Ex1_withoutDDF 
{
	public static void main(String[] args) throws InterruptedException 
	{
		...
		//enter mobile number
		driver.findElement(By.xpath("(//input[@id='central-login-module-sign-mobile'])[2]")).sendKeys("7387100353");
		...
		//enter pwd
		driver.findElement(By.xpath("//input[@name='password']")).sendKeys("Pbazaar@1819");
		Thread.sleep(2000);
